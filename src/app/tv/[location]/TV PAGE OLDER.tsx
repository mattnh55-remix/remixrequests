...
const PLACEHOLDER_MESSAGES: ScheduledMessage[] = [
  {
    id: "msg1",
...
export default function TvPage({ params }: { params: { location: string } }) {
  ...
  const [liveMessage, setLiveMessage] = useState<ScheduledMessage | null>(null);
  ...
  const fallbackMessage = PLACEHOLDER_MESSAGES[placeholderIndex % PLACEHOLDER_MESSAGES.length];
  const featuredMessage = liveMessage || fallbackMessage;
  ...
  useEffect(() => {
    ...
    const q = setInterval(tickQueue, 3000);
    const m = setInterval(tickMessages, 5000);
  ...
  return (
    <div className={`neonRoot tv2Root ${boostFlash ? "tvFlash" : ""}`}>
      ...
      <div className="tv2Wrap">
        <section className="neonPanel tv2Left">
          <div className="tv2FeatureHeader">
            <div className="tv2FeatureTitle">{featuredTitle}</div>
          </div>
          ...
          >
            <div className="tv2BubbleInner">
              ...
              <div className="tv2MessageTextCol">
                <div>
                  <div className="tv2ProductKicker">
                    {featuredMessage.productTitle || "Remix Shout Out"}
                  </div>
                  <div className="tv2MessageBody">{featuredBody}</div>
                </div>
      ...
      <style jsx global>{`
        ...
        .tv2Bubble--gold .tv2BubbleTailPath { fill: #e1dc92; }
        .tv2Bubble--cyan .tv2BubbleTailPath { fill: #a9ddf5; }
        .tv2Bubble--pink .tv2BubbleTailPath { fill: #f6aadf; }
        ...
        .tv2HeroBoosted { box-shadow: var(--glowB); }
        .tv2HeroArtWrap { display: flex; align-items: center; }
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .tv2FeatureMediaImg { display: block; }
