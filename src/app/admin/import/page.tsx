...
export default function AdminSpotifyImportPage() {
  ...
  const [featureBoostIds, setFeatureBoostIds] = useState<Record<string, boolean>>({});
  ...
  function toggleSelected(spotifyId: string | null) {
    ...
    setSelectedIds((prev) => ({
      ...prev,
      [spotifyId]: !prev[spotifyId],
    }));
  }

  function toggleFeatureBoost(spotifyId: string | null) {
    if (!spotifyId) return;
    setFeatureBoostIds((prev) => ({
      ...prev,
      [spotifyId]: !prev[spotifyId],
    }));
  }
  ...
  async function importSelected() {
    ...
    const payloadTracks = tracks
      ...
      .map((track) => ({
        ...track,
        featureBoost: track.spotifyId && featureBoostIds[track.spotifyId] ? 100 : 0,
      }));
    ...
    try {
      ...
      setMessage(`Playlist imported successfully into ${data?.location?.name || locationSlug}.`);
    } catch (err: any) {
    ...
    <div className="rrAdminSpotifyPage">
      <div className="rrAdminSpotifyShell">
        <div className="rrAdminHero">
          ...
          <div className="rrAdminHeroText">
            Paste a Spotify playlist, review the album art cards, then import the bangers into your Remix catalog.
          </div>
        </div>
        ...
        <div className="rrPanel">
          <div className="rrPanelHead">
            <div>
              ...
              <div className="rrPanelSub">Staff-friendly, fast, and way more fun than a spreadsheet.</div>
            </div>
            <div className="rrStatusPill">{selectedCount} selected</div>
          </div>

          <div className="rrPanelBody">
            <div className="rrTopFormGrid">
              <input
                className="rrInput"
                value={locationSlug}
          ...
          <div className="rrPlaylistWrap">
            <div className="rrPlaylistCard">
              <div className="rrPlaylistArtWrap">
                {playlist.image ? (
                  <img src={playlist.image} alt={playlist.name} className="rrPlaylistArt" />
                ) : (
                  <div className="rrPlaylistArt rrPlaylistArtPlaceholder">🎧</div>
                )}
              </div>
              ...
              <div className="rrPlaylistMeta">
                ...
                <div className="rrPlaylistSub">
                  {playlist.owner ? `by ${playlist.owner}` : "Spotify playlist"} • {playlist.totalTracks} tracks
                </div>
                {playlist.description ? (
                  <div
                    className="rrPlaylistDesc"
            ...
            <div className="rrPanel">
              <div className="rrPanelHead">
                <div>
                  ...
                  <div className="rrPanelSub">Select what to import. Mark standouts with feature boost.</div>
                </div>
                <div className="rrQuickActions">
                  <button className="rrBtn" onClick={() => setAllVisibleSelected(true)}>
                    Select visible
                  </button>
                  <button className="rrBtn" onClick={() => setAllVisibleSelected(false)}>
                    Clear visible
                  </button>
                  <button
                    className="rrBtn rrBtnPrimary"
              ...
              <div className="rrPanelBody">
                ...
                <div className="rrTrackGrid">
                  {filteredTracks.map((track) => {
                    ...
                    const isFeatureBoosted = !!(track.spotifyId && featureBoostIds[track.spotifyId]);
                    ...
                    return (
                      <div
                        ...
                        className={[
                          ...
                          isFeatureBoosted ? "rrTrackCardFeatured" : "",
                        ].join(" ")}
                      >
                        <button
                          type="button"
                        ...
                        <div className="rrTrackArtWrap">
                          ...
                          <div className="rrTrackCornerBadges">
                            ...
                            {isFeatureBoosted ? <span className="rrChip rrChipFeatured">Feature Boost</span> : null}
                          </div>
                        </div>
                        ...
                        <div className="rrTrackBody">
                          ...
                          <div className="rrTrackFoot">
                            ...
                            <div className="rrTrackActions">
                              ...
                              <button
                                type="button"
                                className={`rrActionBtn rrActionBtnFeature ${isFeatureBoosted ? "rrActionBtnFeatureOn" : ""}`}
                                onClick={(e) => {
                                  e.stopPropagation();
                                  toggleFeatureBoost(track.spotifyId);
                                }}
                              >
                                🔥 Boost
                              </button>
                ...
                {!filteredTracks.length ? (
                  <div className="rrEmpty">No songs match your search.</div>
                ) : null}
              </div>
            </div>
          </div>
      ...
      <style jsx>{`
        .rrAdminSpotifyPage {
          min-height: 100vh;
          background:
            radial-gradient(circle at 20% 0%, rgba(80, 90, 140, 0.14), transparent 38%),
        ...
        .rrAdminHero {
          ...
          background:
            radial-gradient(circle at 12% 14%, rgba(93, 138, 219, 0.18), transparent 28%),
            linear-gradient(135deg, rgba(21, 31, 47, 0.98) 0%, rgba(9, 14, 23, 0.99) 70%, rgba(20, 12, 30, 0.98) 100%);
        ...
        .rrAdminHeroBadge {
          ...
          color: #dceaff;
          border: 1px solid rgba(101, 166, 252, 0.34);
        ...
        .rrPanel {
          ...
          border: 1px solid rgba(108, 137, 186, 0.18);
          background:
            linear-gradient(180deg, rgba(17, 24, 37, 0.94) 0%, rgba(8, 13, 22, 0.98) 100%);
        ...
        .rrBtn {
          ...
          padding: 0 14px;
          color: #ecf4ff;
          background: linear-gradient(180deg, rgba(46, 58, 80, 0.94), rgba(24, 35, 52, 0.98));
          cursor: pointer;
          font: inherit;
          font-weight: 800;
        ...
        .rrBtn:hover {
          border-color: rgba(126, 164, 231, 0.28);
        }
        ...
        .rrBtnPrimary {
          ...
          color: white;
          box-shadow: 0 12px 26px rgba(17, 47, 89, 0.32);
        }
        ...
        .rrNoticeSuccess {
          ...
          background: linear-gradient(180deg, rgba(18, 44, 31, 0.86), rgba(11, 26, 19, 0.96));
          color: #dff8e8;
        }

        .rrNoticeError {
          border: 1px solid rgba(205, 91, 91, 0.26);
          background: linear-gradient(180deg, rgba(53, 20, 20, 0.86), rgba(29, 11, 11, 0.96));
          color: #ffdede;
        }
        ...
        .rrMiniStat {
          ...
          border: 1px solid rgba(108, 137, 186, 0.18);
          background:
            linear-gradient(180deg, rgba(18, 27, 43, 0.96), rgba(10, 16, 27, 0.98));
        }
        ...
        .rrPlaylistCard {
          ...
          border: 1px solid rgba(108, 137, 186, 0.18);
          background:
            radial-gradient(circle at 10% 20%, rgba(92, 142, 220, 0.16), transparent 30%),
        ...
        .rrTrackCardFeatured {
          background:
            radial-gradient(circle at 18% 12%, rgba(245, 105, 55, 0.16), transparent 30%),
            linear-gradient(135deg, rgba(38, 29, 52, 0.98) 0%, rgba(17, 21, 36, 0.99) 68%, rgba(12, 16, 27, 0.995) 100%);
        }
        ...
        .rrChipSelected {
          ...
          background: rgba(24, 63, 116, 0.78);
        }

        .rrChipFeatured {
          color: #fff3ea;
          border: 1px solid rgba(255, 162, 109, 0.28);
          background: rgba(110, 46, 16, 0.8);
        }
        ...
        .rrActionBtnFeature {
          background: linear-gradient(180deg, rgba(73, 52, 38, 0.96), rgba(44, 28, 18, 0.98));
          border-color: rgba(196, 128, 83, 0.2);
        }

        .rrActionBtnFeatureOn {
          background: linear-gradient(180deg, rgba(255, 122, 69, 0.98), rgba(202, 84, 33, 0.99));
          border-color: rgba(255, 171, 129, 0.34);
          color: #fff;
        }
